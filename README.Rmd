...
This example demonstrates the complete workflow using bird occurrence data from the DC Metro region (1985-2023). The preprocessing and modeling steps are computationally intensive and are shown with `eval=FALSE` for documentation purposes.
...
Extract environmental values at occurrence locations, calculating scaling parameters:

```{r extract_values, eval=FALSE}
variable_patterns <- c(
...
```{r show_partition_plot, echo=FALSE, out.width="100%", fig.cap="Spatiotemporal partition showing fold distribution across space and time"}
...
```{r build_hypervolumes, eval=FALSE}
...
```{r show_hypervolume_comparison, echo=FALSE, out.width="100%", fig.cap="Hypervolume comparison across cross-validation folds"}
...
```{r generate_predictions, eval=FALSE}
...
The `plot_model_assessment()` function generates diagnostic plots showing model performance over time:

```{r show_assessment_volume_sensitivity, echo=FALSE, out.width="100%", fig.cap="Hypervolume size and sensitivity metrics over time"}
knitr::include_graphics("man/figures/README-model_assessment_volume_sensitivity.png")
```

```{r show_assessment_cbp_gspace, echo=FALSE, out.width="100%", fig.cap="Continuous Binomial Probability in Geographic Space (G-space)"}
knitr::include_graphics("man/figures/README-model_assessment_cbp_gspace.png")
```

```{r show_assessment_cbp_espace, echo=FALSE, out.width="100%", fig.cap="Continuous Binomial Probability in Environmental Space (E-space)"}
...
```{r summarize_predictions, eval=FALSE}
...
```{r show_summary_raster, echo=FALSE, out.width="80%", fig.cap="Summary raster showing proportion of years with suitable habitat (1986-2023)"}
...
```{r show_pattern_classification, echo=FALSE, out.width="80%", fig.cap="Temporal pattern classification showing habitat trends across the DC Metro region"}
...
The `analyze_trends_by_spatial_unit()` function generates comprehensive spatial summaries:

```{r show_county_pattern_composition, echo=FALSE, out.width="100%", fig.cap="Pattern composition by county with pie charts showing temporal trend distributions"}
knitr::include_graphics("man/figures/README-county_pattern_composition.png")
```

```{r show_county_timeseries, echo=FALSE, out.width="100%", fig.cap="Habitat availability time series by county (1986-2023)"}
knitr::include_graphics("man/figures/README-county_habitat_timeseries.png")
```

```{r show_county_gains_losses, echo=FALSE, out.width="100%", fig.cap="Annual habitat gains and losses across both counties"}
knitr::include_graphics("man/figures/README-county_gains_losses.png")
```

```{r show_county_change_by_unit, echo=FALSE, out.width="100%", fig.cap="Gains and losses by county over time"}
knitr::include_graphics("man/figures/README-county_change_by_unit.png")
```

```{r show_county_total_change, echo=FALSE, out.width="100%", fig.cap="Total habitat change by county across the entire study period"}
knitr::include_graphics("man/figures/README-county_total_change.png")
```

```{r show_county_faceted, echo=FALSE, out.width="100%", fig.cap="Faceted timeline showing temporal trends within each county"}
