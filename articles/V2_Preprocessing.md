...
#> $spatiotemporal
#> [1] "/tmp/RtmpL1DGhr/rarefied/Pts_seasonal_OnePerPixPerTimeStep.csv"
#> 
#> $spatial
#> [1] "/tmp/RtmpL1DGhr/rarefied/Pts_seasonal_OnePerPix.csv"
```
...
#> $raw
#> [1] "/tmp/RtmpL1DGhr/extracted/extracted_seasonal_Raw_Values.csv"
#> 
#> $scaled
#> [1] "/tmp/RtmpL1DGhr/extracted/extracted_seasonal_Scaled_Values.csv"
#> 
#> $scaling_params
#> [1] "/tmp/RtmpL1DGhr/extracted/extracted_seasonal_Scaling_Parameters.csv"
```
...
![](V2_Preprocessing_files/figure-html/unnamed-chunk-12-1.png)![](V2_Preprocessing_files/figure-html/unnamed-chunk-12-2.png)

    #> Spherical geometry (s2) switched off
    #> Spherical geometry (s2) switched on

![](V2_Preprocessing_files/figure-html/unnamed-chunk-12-3.png)
