...
#> $spatiotemporal
#> [1] "/tmp/Rtmpsme5Tt/rarefied/Pts_seasonal_OnePerPixPerTimeStep.csv"
#> 
#> $spatial
#> [1] "/tmp/Rtmpsme5Tt/rarefied/Pts_seasonal_OnePerPix.csv"
```
...
#> $raw
#> [1] "/tmp/Rtmpsme5Tt/extracted/extracted_seasonal_Raw_Values.csv"
#> 
#> $scaled
#> [1] "/tmp/Rtmpsme5Tt/extracted/extracted_seasonal_Scaled_Values.csv"
#> 
#> $scaling_params
#> [1] "/tmp/Rtmpsme5Tt/extracted/extracted_seasonal_Scaling_Parameters.csv"
```
